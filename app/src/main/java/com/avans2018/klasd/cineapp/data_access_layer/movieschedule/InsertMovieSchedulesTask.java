...
public class InsertMovieSchedulesTask extends AsyncTask<String, Void, String> {

    private GetMovieSchedulesListener getMovieSchedulesListener;
    private Movie movie;
    private Date date;

    public InsertMovieSchedulesTask(GetMovieSchedulesListener getMovieSchedulesListener, Movie movie, Date date) {
